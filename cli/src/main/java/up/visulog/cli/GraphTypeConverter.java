...
public class GraphTypeConverter implements ITypeConverter<GraphType> {
     ...
     */
    @Override
    public GraphType convert(String value) throws Exception {
        try {
            return GraphType.fromString(value);
